...
//functie de interschimbare a elementelor din lista adiacente
void interschimbare_el(int poz,ListaDubla lista) {
	int i = 0;
	ListaDubla temp = lista;
	while (i < poz - 1) {
		temp.prim = temp.prim->next;
		i++;
...
int main()
{
	...
	//interschimbare el adiacente
	interschimbare_el(1, listaD);
	printf("\n\nLista dubla dupa interschimbare:\n");
	traversare_listadubla(listaD);
